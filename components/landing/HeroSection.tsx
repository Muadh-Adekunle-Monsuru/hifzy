...
export function HeroSection() {
  return (
    <MotionDiv
      initial="hidden"
      animate="visible"
      className="h-[70vh] flex flex-col items-center justify-center gap-lg rounded-4xl"
      style={{
    ...
    >
      <MotionDiv variants={fadeUp} className="max-w-2xl text-center px-10">
        <h1 className="text-5xl font-bold text-primary mb-md">
          Master Your Hifz Through Active Recall
        </h1>
        <p className="text-gray-400 text-lg font-medium mb-lg">
        ...
        <Link
          href="/dashboard"
          className="bg-primary text-on-primary font-bold px-lg py-sm border-2 border-primary cursor-pointer hover:scale-105 active:scale-95 hover:bg-on-primary/80 hover:text-on-surface transition-all duration-100 ease-linear hover:border-on-surface"
        >
          Begin Revision
        </Link>
      </MotionDiv>
