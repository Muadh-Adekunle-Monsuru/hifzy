...
export class Range extends Model {
  ...
  get reciter(): number {
    return this.asModel._getRaw("reciter") as number;
  }
  set reciter(value: number) {
    this.asModel._setRaw("reciter", value);
  }

  get startPage(): number | null {
    return this.asModel._getRaw("start_page") as number;
  }
  set startPage(value: number | null) {
    this.asModel._setRaw("start_page", value);
  }

  get endPage(): number | null {
    return this.asModel._getRaw("end_page") as number;
  }
  set endPage(value: number | null) {
    this.asModel._setRaw("end_page", value);
  }
