...
export const dbSchema = appSchema({
  ...
  tables: [
    tableSchema({
      name: "range",
      columns: [
        { name: "start_surah_number", type: "number" },
        { name: "start_surah_name", type: "string" },
        { name: "start_ayah_number", type: "number" },
        { name: "end_surah_number", type: "number" },
        { name: "end_surah_name", type: "string" },
        { name: "end_ayah_number", type: "number" },
